...
async def cli_main(cli_config: CLIConfig):
    ...
    run_name = f"{datetime.now().strftime('%Y-%m-%d-%H-%M-%S')}-{model_name}-{cli_config.lora_rank}rank-{cli_config.learning_rate}lr-{cli_config.group_size}group-{cli_config.groups_per_batch}batch-{cli_config.loss_fn}-seed{cli_config.seed}"
