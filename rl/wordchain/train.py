...
from rl.wordchain.dataset import WordchainDatasetBuilder


@chz.chz
class CLIConfig:
    """Command-line configuration for wordchain RL training."""
...
async def cli_main(cfg: CLIConfig):
    ...
    dataset_builder = WordchainDatasetBuilder(
